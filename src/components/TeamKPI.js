        ...
        <div className="animate-fade-in space-y-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex bg-[#0c1a2f]/80 p-1 rounded-2xl border border-white/10 backdrop-blur-sm">
                        {[
                    ...
                    <button
                        onClick={fetchStats}
                        className="p-3 bg-white/5 border border-white/10 rounded-2xl text-[#cc9d37] hover:bg-white/10 transition-all"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#0c1a2f]/50 border border-white/10 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-8 opacity-5 text-white"><Coins size={60} /></div>
                    ...
                    <p className="text-4xl font-black text-[#cc9d37]">฿{formatCurrency(summary.totalRevenue)}</p>
                ...
                <div className="bg-[#0c1a2f]/50 border border-white/10 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-8 opacity-5 text-white"><Users size={60} /></div>
                ...
                <div className="bg-[#0c1a2f]/50 border border-white/10 p-8 rounded-[2.5rem] relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-8 opacity-5 text-white"><Percent size={60} /></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 bg-[#0c1a2f]/50 border border-white/10 rounded-[2.5rem] p-8 relative">
                    <h3 className="font-black text-white text-xl tracking-tight mb-10 flex items-center gap-3">
                        <Trophy className="text-[#cc9d37]" size={14} /> Revenue Leaderboard
                    </h3>
                                ...
                                <div key={i} className="group cursor-default">
                                    <div className="flex justify-between items-end mb-3 px-2">
                                        <div className="flex items-center gap-4">
                                            <div className={`w-8 h-8 rounded-xl flex items-center justify-center font-black text-xs ${i === 0 ? 'bg-[#cc9d37] text-[#0c1a2f]' : 'bg-white/10 text-white/40'
                                                }`}>
                                                #{i + 1}
                                            </div>
                                            <div>
                                                <p className="text-sm font-black text-white group-hover:text-[#cc9d37] transition-colors">{agent.name}</p>
                                        ...
                                        <div className="text-right flex items-center gap-6">
                                            ...
                                            >
                                                <p className="text-sm font-black text-white group-hover:text-[#cc9d37] transition-colors">{agent.customers} Customers</p>
                                            ...
                                            <div
                                                ...
                                                className="cursor-pointer hover:bg-white/5 p-2 rounded-xl transition-all border border-transparent hover:border-[#cc9d37]/30"
                                            >
                                                <p className="text-sm font-black text-[#cc9d37]">฿{formatCurrency(agent.revenue)}</p>
                                                <p className="text-[8px] text-[#cc9d37]/40 font-bold uppercase tracking-widest">Click for details</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden hover:bg-white/10 transition-colors">
                                        <div
                                            style={{ width: `${percent}%` }}
                                            className={`h-full rounded-full relative transition-all duration-1000 ${i === 0 ? 'bg-gradient-to-r from-amber-600 to-[#cc9d37]' : 'bg-white/20'
                                                }`}
                                        >
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-gradient-to-br from-indigo-900/40 to-[#0c1a2f] border border-white/10 rounded-[2.5rem] p-8">
                    ...
                    <div className="bg-gradient-to-br from-[#cc9d37]/20 to-[#0c1a2f] border border-white/10 rounded-[2.5rem] p-8">
                        ...
                        {(() => {
                            ...
                            return (
                                <div>
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-16 h-16 rounded-[1.5rem] bg-[#cc9d37]/20 border border-[#cc9d37]/30 flex items-center justify-center text-[#cc9d37] text-3xl font-black">
                                            {(bestAOV.name || 'A').charAt(0)}
                                        </div>
                                        <div>
                                            <p className="font-black text-white text-xl">{bestAOV.name}</p>
                                            <p className="text-xs text-[#cc9d37] font-bold uppercase tracking-widest">High-Ticket closer</p>
                                        </div>
                                    </div>
                                    <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                        <p className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1">Avg. Order Value (AOV)</p>
                                        <p className="text-2xl font-black text-[#cc9d37]">฿{formatCurrency(bestAOV.avgOrderValue)}</p>
                                    </div>
                                </div>
                            );
                        })()}
            ...
            {selectedAgentDetail && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-[#0c1a2f]/80 backdrop-blur-md" onClick={() => setSelectedAgentDetail(null)}></div>
                    <div className="relative bg-gradient-to-br from-[#19273a] to-[#0c1a2f] border border-white/10 w-full max-w-2xl rounded-[3rem] shadow-2xl overflow-hidden animate-scale-up p-12">
                        <button
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-[#cc9d37] text-[10px] font-black uppercase tracking-[0.2em]">
                                        ...
                                        getLinkedData(selectedAgentDetail.agent.name).assignedCustomers.map(c => (
                                            <div key={c.id} className="flex justify-between items-center p-5 bg-white/5 rounded-2xl border border-white/5 hover:border-white/20 transition-all">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-xs font-black text-[#cc9d37]">฿{(c.intelligence?.metrics?.total_spend || 0).toLocaleString()}</p>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-4 flex items-center gap-2">
                                            <Database size={14} /> CRM Recorded Orders (฿{formatCurrency(selectedAgentDetail.agent.crmRevenue || 0)})
                                        </p>
                                        <div className="space-y-3">
                                            {getLinkedData(selectedAgentDetail.agent.name).sales.length > 0 ? (
                                                getLinkedData(selectedAgentDetail.agent.name).sales.sort((a, b) => new Date(b.date) - new Date(a.date)).map((s, idx) => (
                                                    <div key={idx} className="p-5 bg-white/5 rounded-2xl border border-white/5 hover:border-[#cc9d37]/30 transition-all">
                                                        <div className="flex justify-between items-start mb-2">
                                                            <div>
                                                                <p className="text-[10px] font-black text-[#cc9d37] uppercase tracking-widest">{s.orderId}</p>
                                    ...
                                    {/* Attribution Section */}
                                    <div>
                                        <p className="text-[10px] font-black text-[#cc9d37] uppercase tracking-widest mb-4 flex items-center gap-2">
                                            <Facebook size={14} /> Meta Ads Attribution (฿{formatCurrency(selectedAgentDetail.agent.attributed?.revenue || 0)})
                                        </p>
                                        <div className="space-y-3">
                                            <>
                                                {(selectedAgentDetail.agent.attributed?.ads || []).map((ad, idx) => (
                                                    <div key={idx} className="p-5 bg-[#cc9d37]/5 rounded-2xl border border-[#cc9d37]/10 flex justify-between items-center group hover:bg-[#cc9d37]/10 transition-all">
                                                        <div className="max-w-[70%]">
                                                            <p className="text-[11px] font-black text-white group-hover:text-[#cc9d37] transition-colors">{ad.name}</p>
                                                            <p className="text-[9px] text-white/20 font-bold uppercase tracking-widest">Source: Meta Ads Manager</p>
                                                        </div>
                                                        <div className="text-right">
                                                            <p className="text-sm font-black text-[#cc9d37]">฿{formatCurrency(ad.share)}</p>
                                                            <p className="text-[8px] text-[#cc9d37]/40 font-black uppercase">Statistically Attributed</p>
                                                        </div>
                                                    </div>
                                                ))}
                        ...
                        <div className="mt-8 flex justify-end">
                            <button
                                ...
                                className="px-6 py-4 bg-[#cc9d37] text-[#0c1a2f] rounded-2xl font-black text-xs tracking-widest uppercase hover:scale-105 transition-all w-full flex justify-center items-center gap-3 shadow-[0_0_20px_rgba(201,163,78,0.2)]"
                            >
                                <Search size={14} /> Inspect these chats in CRM
                            </button>
                        </div>
                        ...
                        <div className="mt-6 p-6 rounded-3xl bg-indigo-500/5 border border-indigo-500/10 text-center">
                            <p className="text-[10px] text-indigo-400 font-bold uppercase tracking-widest leading-loose">
                                <ShieldCheck className="mr-2" size={14} /> Hybrid attribution system: Direct CRM matches + Statistical Meta Ads distribution.
                            </p>
                        </div>
                    </div>
                </div>
