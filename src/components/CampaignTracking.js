...
import { AlertTriangle, CheckCircle2, ShieldCheck, Loader2, Zap, ListChecks, TrendingUp, Flame, ArrowDownWideNarrow, RefreshCw, Megaphone, Coins, Wallet, Images, Image, EyeOff, Layers, ChevronUp, ChevronDown, UserCircle, ShoppingCart } from 'lucide-react';
...
const DataIntegrityHeader = ({ syncTime, healthScore, onForceSync, isSyncing }) => (
    <div className="flex items-center justify-between mb-8 px-8 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-sm">
        <div className="flex items-center gap-6">
            ...
            >
                {isSyncing ? (
                    <><Loader2 className="animate-spin" size={14} /> Syncing via Live API...</>
                ) : (
                    <><Zap size={14} /> Force Sync Now</>
                )}
            </button>
        </div>
                    ...
                    {viewMode === 'performance' && (
                        <>
                            ...
                            <div className="flex items-center bg-white/5 border border-white/10 rounded-xl px-3 py-1">
                                <ArrowDownWideNarrow className="text-white/20 mr-2" size={10} />
                                <select
                                    value={sortBy}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                                    <div className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1">
                                        <Megaphone className="text-indigo-400" size={14} /> Active Campaigns
                                    </div>
                                ...
                                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl">
                                    <div className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1">
                                        <Coins className="text-amber-400" size={14} /> Total Spend
                                    </div>
                                ...
                                <div className="bg-white/5 border border-white/10 p-5 rounded-2xl relative overflow-hidden">
                                    <div className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1">
                                        <Flame className="text-orange-400" size={14} /> Burn Rate
                                    </div>
                            ...
                            <div key={campaign.id} className="bg-white/5 border border-white/10 rounded-[2.5rem] overflow-hidden">
                                ...
                                <div className="px-8 pt-6 pb-0">
                                    <h4 className="text-xs font-black text-white/60 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                                        <Images className="text-purple-400" size={14} /> Visual Context
                                    </h4>
                                    <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                                        {ads.filter(a => String(a.campaign_id) === String(campaign.id)).length > 0 ? (
                                            ...
                                            <div className="flex items-center gap-2 text-white/20 text-xs font-mono py-4 px-2">
                                                <EyeOff size={14} /> No visual creatives found
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="px-8 pt-8 pb-0">
                                    <h4 className="text-xs font-black text-white/60 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                                        <Layers className="text-blue-400" size={14} /> Ad Set Breakdown
                                    </h4>
                                                        ...
                                                        <React.Fragment key={idx}>
                                                            ...
                                                            >
                                                                <td className="py-3 px-2">
                                                                    <div className="flex items-center gap-2">
                                                                        {isExpanded ? <ChevronUp className="text-white/30 group-hover:text-white/60 transition-colors w-4" size={10} /> : <ChevronDown className="text-white/30 group-hover:text-white/60 transition-colors w-4" size={10} />}
                                                                                                ...
                                                                                                <td className="py-2 px-4 text-right text-[10px] text-white/40">
                                                                                                    {ad.created_by ? (
                                                                                                        <span className="flex items-center justify-end gap-1">
                                                                                                            <UserCircle size={14} /> {ad.created_by.split(' ')[0]}
                                                                                                        </span>
                                                                                                    ) : '-'}
                                                                                                </td>
                                                                                            </tr>
                                ...
                                <div className="p-8">
                                    ...
                                    {campaignOrders.length > 0 ? (
                                        ...
                                        <div className="py-12 text-center bg-white/5 rounded-3xl border border-white/5 border-dashed">
                                            <ShoppingCart className="text-white/10 mb-3" size={24} />
