'use client';
import { ImageOff, X, Loader2, AlertTriangle, Banknote, Percent, Eye, MousePointer } from 'lucide-react';
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                {[
                                    { label: 'Spend', value: `฿${fmt(ad.spend, 2)}`, Icon: Banknote, color: 'text-blue-400' },
                                    { label: 'CTR', value: `${fmt(ad.ctr, 2)}%`, Icon: Percent, color: 'text-emerald-400' },
                                    { label: 'Impressions', value: fmt(ad.impressions), Icon: Eye, color: 'text-purple-400' },
                                    { label: 'Link Clicks', value: fmt(ad.clicks), Icon: MousePointer, color: 'text-indigo-400' },
                                ].map((stat, i) => (
