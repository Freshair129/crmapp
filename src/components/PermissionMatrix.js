...
import { CheckCircle2, XCircle, Eye, AlertTriangle, Lock } from 'lucide-react'
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
        <div className="flex gap-3">
          ...
          <div>
            <p className="text-white/80 text-xs font-bold mb-1">Read-Only View</p>
            <p className="text-white/50 text-[10px]">
              This matrix shows inherited permissions for the selected role. Permissions are evaluated at request time
              using the <code className="bg-black/30 px-1.5 py-0.5 rounded text-[9px]">canWithMeta()</code> function.
            </p>
          </div>
        </div>
      </div>
