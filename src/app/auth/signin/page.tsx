...
function SignInForm() {
    ...
    return (
        <div className="min-h-screen bg-[#0c1a2f] flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Effects */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#cc9d37]/10 rounded-full blur-3xl animate-pulse" />
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-10">
                    <div className="w-20 h-20 bg-[#cc9d37] rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-[#cc9d37]/20">
                        <span className="text-[#0c1a2f] font-black text-3xl">V</span>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-5 py-4 text-white font-bold placeholder:text-white/20 outline-none focus:border-[#cc9d37]/50 focus:ring-2 focus:ring-[#cc9d37]/20 transition-all"
                                    value={email}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-14 py-4 text-white font-bold placeholder:text-white/20 outline-none focus:border-[#cc9d37]/50 focus:ring-2 focus:ring-[#cc9d37]/20 transition-all"
                                    value={password}
                        ...
                        <div className="flex items-center gap-3 px-1 pt-1">
                            <button
                                ...
                                className={`w-5 h-5 rounded-md border-2 flex items-center justify-center shrink-0 transition-all ${
                                    rememberMe
                                        ? "bg-[#cc9d37] border-[#cc9d37]"
                                        : "bg-transparent border-white/20 hover:border-white/50"
                                }`}
                                aria-label="จดจำการเข้าสู่ระบบ"
                            >
                                {rememberMe && (
                                    <svg className="w-3 h-3 text-[#0c1a2f]" fill="none" viewBox="0 0 12 12">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-[#cc9d37] text-[#0c1a2f] py-4 rounded-2xl font-black text-sm uppercase tracking-[0.2em] shadow-xl shadow-[#cc9d37]/20 hover:scale-[1.02] transition-transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
                        >
                            {isLoading ? (
                                <>
...
export default function SignInPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen flex items-center justify-center bg-[#0c1a2f]">
                <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#cc9d37]" />
            </div>
        }>
            <SignInForm />
        </Suspense>
