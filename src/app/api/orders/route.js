        ...
        const order = await prisma.$transaction(async (tx) => {
            return tx.order.create({
                data: {
                    ...
                    deliveryPlatform: body.deliveryPlatform || null,
                    deliveryOrderId: body.deliveryOrderId || null,
                    deliveryGpRate: body.deliveryGpRate ? Number(body.deliveryGpRate) : null,
                    deliveryNetAmount: body.deliveryNetAmount ? Number(body.deliveryNetAmount) : null,
                    isGuestOrder: body.isGuestOrder || false,
                    items: body.items || [],
